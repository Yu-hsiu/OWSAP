...
>
> 📌 **目前進度**:本 repo 已包含 **API1 ~ API8**(各含 vulnerable / secure / 攻擊
> 腳本 / 一鍵展示);API9 ~ API10 為規劃中的路線圖(見下方進度表)。
...
- **API1–API8 已完成**(BOLA、BrokenAuth、BOPLA、ResourceConsumption、BFLA、BusinessFlows、SSRF、Misconfiguration,本機實跑通過)。其餘兩項待逐項展開。
